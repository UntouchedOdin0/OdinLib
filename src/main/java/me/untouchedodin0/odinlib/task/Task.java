package me.untouchedodin0.odinlib.task;
...
public class Task {
    ...
    public static Task syncDelayed(Runnable run) {
        return syncDelayed(OdinLib.getCallingPlugin(), run);
    }
    ...
    public static Task syncDelayed(Runnable run, long delay) {
        return syncDelayed(OdinLib.getCallingPlugin(), run, delay);
    }
    ...
    public static Task syncRepeating(Runnable run, long delay, long period) {
        return syncRepeating(OdinLib.getCallingPlugin(), run, delay, period);
    }
    ...
    public static Task asyncDelayed(Runnable run) {
        return asyncDelayed(OdinLib.getCallingPlugin(), run);
    }
    ...
    public static Task asyncDelayed(Runnable run, long delay) {
        return asyncDelayed(OdinLib.getCallingPlugin(), run, delay);
    }
    ...
    public static Task asyncRepeating(Consumer<Task> run, long delay, long period) {
        return asyncRepeating(OdinLib.getCallingPlugin(), run, delay, period);
    }
